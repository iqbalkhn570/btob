...
class SwitchoffonController extends Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:switchoffon-list|switchoffon-create|switchoffon-edit|switchoffon-delete', ['only' => ['index','show']]);
        $this->middleware('permission:switchoffon-create', ['only' => ['create','store']]);
        $this->middleware('permission:switchoffon-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:switchoffon-delete', ['only' => ['destroy']]);
