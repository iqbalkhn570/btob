...
class UndertakeSettingController extends Controller
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:undertake-setting-list|undertake-setting-create|undertake-setting-edit|undertake-setting-delete', ['only' => ['index','show']]);
        $this->middleware('permission:undertake-setting-create', ['only' => ['create','store']]);
        $this->middleware('permission:undertake-setting-edit', ['only' => ['edit','update']]);
        $this->middleware('permission:undertake-setting-delete', ['only' => ['destroy']]);
