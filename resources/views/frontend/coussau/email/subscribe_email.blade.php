...
<div>
  <p style="font-family:Arial, Helvetica, Gill Sans, Lucida, Helvetica Narrow, sans-serif; font-size:16px; text-align: center; margin-bottom: 15px; margin-top: 0; line-height:1.7; padding-left: 20px; padding-right: 20px;">Hi <b>{{$email}}</b>, We have received your information regarding <b>Subscription</b></div>
</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
