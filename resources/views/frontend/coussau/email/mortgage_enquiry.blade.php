...
<div>
  <p style="font-family:Arial, Helvetica, Gill Sans, Lucida, Helvetica Narrow, sans-serif; font-size:16px; text-align: center; margin-bottom: 15px; margin-top: 0; line-height:1.7; padding-left: 20px; padding-right: 20px;">Hi <b>{{ $customer_name }}</b>, We have recieved your information regarding  <b>{{ $coussau_type['name'] }}</b>. We are reviewing your information, One of our expert will follow up shortly to provide a FREE one-to-one consultation.</div>
</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
