                ...
                @if(Session::has('message'))
                    ...
                    <div class="card-body table-responsive p-0">
                        ...
                        <thead>
                            ...
                            <th>@sortablelink('content',__('messages.Description'))</th>
...
<td>{{ $info->created_at }}</td>
                           ...
                           @endcan
                                ...
                                <!--<a onclick="return confirm('{{ __('messages.Are You Sure, You Want To Delete') }} {{$info->title}}  role ?. It will also delete all users of this role.');" class="btn btn-sm btn-danger" href="{{route($delete_action, ['id'=>$info->id] )}}"><i class="fa fas fa-trash-alt" title="Delete" ></i></a>-->
                                @endcan
                            </div>
                            </td>
                            </tr>
                        @endforeach
                         @else
                                <tr><td colspan="3" class="text-center">{{ __('messages.Record not found') }}.</td></tr>
                              @endif
