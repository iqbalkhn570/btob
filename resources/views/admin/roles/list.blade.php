                ...
                @if(Session::has('message'))
                    ...
                    <div class="card-body table-responsive p-0">
                        ...
                        <thead>
                            ...
                            <th>@sortablelink('name',__('messages.Role'))</th>
...
<td>{{ $info->created_at }}</td>
                           ...
                           @endcan
                                ...
                                @can('role-delete')
                                <a onclick="return confirm('{{ __('messages.Are You Sure, You Want To Delete') }} {{$info->name}}  role ?. It will also delete all users of this role.');" class="btn btn-sm btn-danger" href="{{route($delete_action, ['id'=>$info->id] )}}"><i class="fa fas fa-trash-alt" title="Delete" ></i></a>
                                @endcan
                            </div>
                            </td>
                            </tr>
